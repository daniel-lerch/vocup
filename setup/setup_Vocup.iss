...
[Files]
Source: ..\src\Vocup\bin\Release\CsvHelper.dll;                DestDir: {app}; Flags: ignoreversion replacesameversion ; Check:  check_dont_install
Source: ..\src\Vocup\bin\Release\help.chm;                     DestDir: {app}; Flags: ignoreversion replacesameversion ; Check:  check_dont_install
Source: ..\src\Vocup\bin\Release\ICSharpCode.SharpZipLib.dll;  DestDir: {app}; Flags: ignoreversion replacesameversion ; Check:  check_dont_install
Source: ..\src\Vocup\bin\Release\K_Updater.dll;                DestDir: {app}; Flags: ignoreversion replacesameversion ; Check:  check_dont_install
Source: ..\src\Vocup\bin\Release\Vocup.exe;                    DestDir: {app}; Flags: ignoreversion replacesameversion ; Check:  check_dont_install
Source: ..\src\Vocup\bin\Release\Vocup.exe.config;             DestDir: {app}; Flags: ignoreversion replacesameversion ; Check:  check_dont_install
Source: ..\src\Vocup\bin\Release\Vocup.pdb;                    DestDir: {app}; Flags: ignoreversion replacesameversion ; Check:  check_dont_install
...
[Icons]
Name: {commonprograms}\Vocup;         Filename: {app}\Vocup.exe                              ; Check:  check_dont_install
...
;Beschreibung der Aktion festlegen
Root: HKCR; Subkey: "vdp.File\shell\open";         ValueType: string; ValueName: ""; ValueData: "Mit Vocup öffnen";           Flags: uninsdeletekey deletevalue; Check: check_dont_install
