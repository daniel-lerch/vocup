...
namespace Vocup.Controls
{
    public partial class StatisticsPanel : UserControl
    {
        ...
        {
            get => _unpracticed;
            set { _unpracticed = value; LbUnpracticed.Text = value.ToString(); }
        }
        public int WronglyPracticed
        {
            get => _wronglyPracticed;
            set { _wronglyPracticed = value; LbWronglyPracticed.Text = value.ToString(); }
        }
        public int CorrectlyPracticed
        {
            get => _correctlyPracticed;
            set { _correctlyPracticed = value; LbCorrectlyPracticed.Text = value.ToString(); }
        }
        public int FullyPracticed
        {
            get => _fullyPracticed;
            set { _fullyPracticed = value;LbFullyPracticed.Text = value.ToString(); }
        }
    }
}
