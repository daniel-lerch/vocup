// Copied from https://github.com/dotnet/corefx/blob/release/2.0.0/src/System.IO.FileSystem.Watcher/src/System/IO/PatternMatcher.cs
// and slightly changes to fit .NET Framework 4.5.2
